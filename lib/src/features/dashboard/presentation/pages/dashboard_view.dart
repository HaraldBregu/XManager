...
import '../../data/models/dashboard_player_model.dart';
...
**/
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => dashboardBloc,//..add(DashboardPlayerEvent()),
        child: BlocBuilder<DashboardBloc, DashboardState>(
          builder: (context, state) {
            if (state is DashboardTestState) {
              return Center(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          ...
          var json = objectBox.playerBox.getAll().first.toJson();
          var objecjson = DashboardPlayerModel.fromJson(json);
          print(objecjson.id);
