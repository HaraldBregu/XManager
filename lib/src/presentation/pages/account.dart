...
import 'package:xmanager/src/presentation/widgets/theme_mode_switch.dart';

import '../../data/models/device_program.dart';
import '../../data/models/player.dart';
import '../../data/models/session_program.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (kDebugMode) {
      ...
      widgets.add(ListTile(
        ...
        onTap: () {
          final testSliver = const TestSliver();
