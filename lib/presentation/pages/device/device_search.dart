...
import 'package:xmanager/presentation/pages/device/device_detail_test.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            TextButton(
              child: Text("SEARCH"),
              onPressed: () => FlutterBluePlus.instance.startScan(timeout: const Duration(seconds: 5)),
            ),
          ],
        ),
                          ...
                          if (snapshot.data ==
                            ...
                            return ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => DeviceDetailTest(device: d)),
                                );
                              },
                            );
                          }
                  ...
                  builder: (c, snapshot) {
                    return Column(children: snapshot.data!.map((r) => ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => DeviceDetailTest(device: r.device)),
                        );
                      },
                    )).toList());
                  },
