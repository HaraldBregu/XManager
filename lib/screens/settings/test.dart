...
class BleDevicesList extends StatefulWidget {
  BleDevicesList({Key? key, required this.title}) : super(key: key);
  ...
  @override
  BleDevicesListState createState() => BleDevicesListState();
}

class BleDevicesListState extends State<BleDevicesList> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      title: Text(widget.title + widget.devicesList.length.toString()),
    ),
    body: _buildView(),
  );
}