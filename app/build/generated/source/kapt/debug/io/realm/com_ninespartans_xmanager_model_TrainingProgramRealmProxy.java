...
public class com_ninespartans_xmanager_model_TrainingProgramRealmProxy extends com.ninespartans.xmanager.model.TrainingProgram
    implements RealmObjectProxy, com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface {
    ...
    private ProxyState<com.ninespartans.xmanager.model.TrainingProgram> proxyState;
    private RealmList<com.ninespartans.xmanager.model.Program> programsRealmList;

    com_ninespartans_xmanager_model_TrainingProgramRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.ninespartans.xmanager.model.TrainingProgram>(this);
    ...
    @SuppressWarnings("cast")
    public static com.ninespartans.xmanager.model.TrainingProgram createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.ninespartans.xmanager.model.TrainingProgram obj = null;
        if (update) {
            Table table = realm.getTable(com.ninespartans.xmanager.model.TrainingProgram.class);
            TrainingProgramColumnInfo columnInfo = (TrainingProgramColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.TrainingProgram.class);
            ...
            if (objKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.TrainingProgram.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_ninespartans_xmanager_model_TrainingProgramRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("_id")) {
                if (json.isNull("_id")) {
                    obj = (io.realm.com_ninespartans_xmanager_model_TrainingProgramRealmProxy) realm.createObjectInternal(com.ninespartans.xmanager.model.TrainingProgram.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_ninespartans_xmanager_model_TrainingProgramRealmProxy) realm.createObjectInternal(com.ninespartans.xmanager.model.TrainingProgram.class, json.get("_id"), true, excludeFields);
                }
            } else {
        ...
        final com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface objProxy = (com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) obj;
        if (json.has("title")) {
    ...
    public static com.ninespartans.xmanager.model.TrainingProgram createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.ninespartans.xmanager.model.TrainingProgram obj = new com.ninespartans.xmanager.model.TrainingProgram();
        final com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface objProxy = (com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) obj;
        reader.beginObject();
    ...
    static com_ninespartans_xmanager_model_TrainingProgramRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.TrainingProgram.class), false, Collections.<String>emptyList());
        io.realm.com_ninespartans_xmanager_model_TrainingProgramRealmProxy obj = new io.realm.com_ninespartans_xmanager_model_TrainingProgramRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ninespartans.xmanager.model.TrainingProgram copyOrUpdate(Realm realm, TrainingProgramColumnInfo columnInfo, com.ninespartans.xmanager.model.TrainingProgram object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ninespartans.xmanager.model.TrainingProgram) cachedRealmObject;
        }

        com.ninespartans.xmanager.model.TrainingProgram realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.ninespartans.xmanager.model.TrainingProgram.class);
            long pkColumnKey = columnInfo._idColKey;
            long objKey = table.findFirstObjectId(pkColumnKey, ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$_id());
            if (objKey == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_ninespartans_xmanager_model_TrainingProgramRealmProxy();
    ...
    public static com.ninespartans.xmanager.model.TrainingProgram copy(Realm realm, TrainingProgramColumnInfo columnInfo, com.ninespartans.xmanager.model.TrainingProgram newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ninespartans.xmanager.model.TrainingProgram) cachedRealmObject;
        }

        com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface unmanagedSource = (com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) newObject;
        ...
        io.realm.com_ninespartans_xmanager_model_TrainingProgramRealmProxy managedCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.ninespartans.xmanager.model.TrainingProgram object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnKey = columnInfo._idColKey;
        long objKey = Table.NO_MATCH;
        Object primaryKeyValue = ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$_id();
        ...
        String realmGet$title = ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.titleColKey, objKey, realmGet$title, false);
        }
        String realmGet$description = ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.descriptionColKey, objKey, realmGet$description, false);
        }

        RealmList<com.ninespartans.xmanager.model.Program> programsList = ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$programs();
        ...
        java.util.Date realmGet$createdAt = ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetTimestamp(tableNativePtr, columnInfo.createdAtColKey, objKey, realmGet$createdAt.getTime(), false);
        }
        java.util.Date realmGet$updatedAt = ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$updatedAt();
        if (realmGet$updatedAt != null) {
            Table.nativeSetTimestamp(tableNativePtr, columnInfo.updatedAtColKey, objKey, realmGet$updatedAt.getTime(), false);
        }
        java.util.Date realmGet$startDate = ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$startDate();
        if (realmGet$startDate != null) {
            Table.nativeSetTimestamp(tableNativePtr, columnInfo.startDateColKey, objKey, realmGet$startDate.getTime(), false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.activeColKey, objKey, ((com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) object).realmGet$active(), false);
        return objKey;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        TrainingProgramColumnInfo columnInfo = (TrainingProgramColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.TrainingProgram.class);
        long pkColumnKey = columnInfo._idColKey;
        com.ninespartans.xmanager.model.TrainingProgram object = null;
        while (objects.hasNext()) {
            object = (com.ninespartans.xmanager.model.TrainingProgram) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ninespartans.xmanager.model.TrainingProgram object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.ninespartans.xmanager.model.TrainingProgram.class);
    ...
    public static com.ninespartans.xmanager.model.TrainingProgram createDetachedCopy(com.ninespartans.xmanager.model.TrainingProgram realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ninespartans.xmanager.model.TrainingProgram unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ninespartans.xmanager.model.TrainingProgram();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ninespartans.xmanager.model.TrainingProgram) cachedObject.object;
            }
            unmanagedObject = (com.ninespartans.xmanager.model.TrainingProgram) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface unmanagedCopy = (com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) unmanagedObject;
        com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface realmSource = (com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) realmObject;
    ...
    static com.ninespartans.xmanager.model.TrainingProgram update(Realm realm, TrainingProgramColumnInfo columnInfo, com.ninespartans.xmanager.model.TrainingProgram realmObject, com.ninespartans.xmanager.model.TrainingProgram newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface realmObjectTarget = (com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) realmObject;
        com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface realmObjectSource = (com_ninespartans_xmanager_model_TrainingProgramRealmProxyInterface) newObject;
        Table table = realm.getTable(com.ninespartans.xmanager.model.TrainingProgram.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
    ...
    public boolean equals(Object o) {
        ...
        com_ninespartans_xmanager_model_TrainingProgramRealmProxy aTrainingProgram = (com_ninespartans_xmanager_model_TrainingProgramRealmProxy)o;
