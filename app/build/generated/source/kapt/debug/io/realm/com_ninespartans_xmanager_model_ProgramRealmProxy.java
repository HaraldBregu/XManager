...
public class com_ninespartans_xmanager_model_ProgramRealmProxy extends com.ninespartans.xmanager.model.Program
    implements RealmObjectProxy, com_ninespartans_xmanager_model_ProgramRealmProxyInterface {
    ...
    private ProxyState<com.ninespartans.xmanager.model.Program> proxyState;

    com_ninespartans_xmanager_model_ProgramRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.ninespartans.xmanager.model.Program>(this);
    ...
    @SuppressWarnings("cast")
    public static com.ninespartans.xmanager.model.Program createOrUpdateEmbeddedUsingJsonObject(Realm realm, RealmModel parent, String parentProperty, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.ninespartans.xmanager.model.Program obj = realm.createEmbeddedObject(com.ninespartans.xmanager.model.Program.class, parent, parentProperty);

        final com_ninespartans_xmanager_model_ProgramRealmProxyInterface objProxy = (com_ninespartans_xmanager_model_ProgramRealmProxyInterface) obj;
    ...
    public static com.ninespartans.xmanager.model.Program createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.ninespartans.xmanager.model.Program obj = new com.ninespartans.xmanager.model.Program();
        final com_ninespartans_xmanager_model_ProgramRealmProxyInterface objProxy = (com_ninespartans_xmanager_model_ProgramRealmProxyInterface) obj;
        reader.beginObject();
    ...
    static com_ninespartans_xmanager_model_ProgramRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.Program.class), false, Collections.<String>emptyList());
        io.realm.com_ninespartans_xmanager_model_ProgramRealmProxy obj = new io.realm.com_ninespartans_xmanager_model_ProgramRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ninespartans.xmanager.model.Program copyOrUpdate(Realm realm, ProgramColumnInfo columnInfo, com.ninespartans.xmanager.model.Program object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ninespartans.xmanager.model.Program) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.ninespartans.xmanager.model.Program copy(Realm realm, ProgramColumnInfo columnInfo, com.ninespartans.xmanager.model.Program newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ninespartans.xmanager.model.Program) cachedRealmObject;
        }

        com_ninespartans_xmanager_model_ProgramRealmProxyInterface unmanagedSource = (com_ninespartans_xmanager_model_ProgramRealmProxyInterface) newObject;

        Table table = realm.getTable(com.ninespartans.xmanager.model.Program.class);
        ...
        io.realm.com_ninespartans_xmanager_model_ProgramRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        return managedCopy;
    }

    public static long insert(Realm realm, Table parentObjectTable, long parentColumnKey, long parentObjectKey, com.ninespartans.xmanager.model.Program object, Map<RealmModel,Long> cache) {
        Table table = realm.getTable(com.ninespartans.xmanager.model.Program.class);
        long tableNativePtr = table.getNativePtr();
        ProgramColumnInfo columnInfo = (ProgramColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.Program.class);
        long objKey = OsObject.createEmbeddedObject(parentObjectTable, parentObjectKey, parentColumnKey);
        cache.put(object, objKey);
        Number realmGet$deviceLedPositionByte = ((com_ninespartans_xmanager_model_ProgramRealmProxyInterface) object).realmGet$deviceLedPositionByte();
        ...
        Number realmGet$animationByte = ((com_ninespartans_xmanager_model_ProgramRealmProxyInterface) object).realmGet$animationByte();
        ...
        Number realmGet$durationHoursByte = ((com_ninespartans_xmanager_model_ProgramRealmProxyInterface) object).realmGet$durationHoursByte();
        ...
        Number realmGet$durationMinutesByte = ((com_ninespartans_xmanager_model_ProgramRealmProxyInterface) object).realmGet$durationMinutesByte();
        ...
        Number realmGet$durationSecondsByte = ((com_ninespartans_xmanager_model_ProgramRealmProxyInterface) object).realmGet$durationSecondsByte();
    ...
    public static void insert(Realm realm, Table parentObjectTable, long parentColumnKey, long parentObjectKey, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ProgramColumnInfo columnInfo = (ProgramColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.Program.class);
        com.ninespartans.xmanager.model.Program object = null;
        while (objects.hasNext()) {
            object = (com.ninespartans.xmanager.model.Program) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, Table parentObjectTable, long parentColumnKey, long parentObjectKey, com.ninespartans.xmanager.model.Program object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
    ...
    public static com.ninespartans.xmanager.model.Program createDetachedCopy(com.ninespartans.xmanager.model.Program realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ninespartans.xmanager.model.Program unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ninespartans.xmanager.model.Program();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ninespartans.xmanager.model.Program) cachedObject.object;
            }
            unmanagedObject = (com.ninespartans.xmanager.model.Program) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ninespartans_xmanager_model_ProgramRealmProxyInterface unmanagedCopy = (com_ninespartans_xmanager_model_ProgramRealmProxyInterface) unmanagedObject;
        com_ninespartans_xmanager_model_ProgramRealmProxyInterface realmSource = (com_ninespartans_xmanager_model_ProgramRealmProxyInterface) realmObject;
    ...
    static com.ninespartans.xmanager.model.Program update(Realm realm, ProgramColumnInfo columnInfo, com.ninespartans.xmanager.model.Program realmObject, com.ninespartans.xmanager.model.Program newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_ninespartans_xmanager_model_ProgramRealmProxyInterface realmObjectTarget = (com_ninespartans_xmanager_model_ProgramRealmProxyInterface) realmObject;
        com_ninespartans_xmanager_model_ProgramRealmProxyInterface realmObjectSource = (com_ninespartans_xmanager_model_ProgramRealmProxyInterface) newObject;
        Table table = realm.getTable(com.ninespartans.xmanager.model.Program.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
    ...
    public static void updateEmbeddedObject(Realm realm, com.ninespartans.xmanager.model.Program unmanagedObject, com.ninespartans.xmanager.model.Program managedObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        update(realm, (com_ninespartans_xmanager_model_ProgramRealmProxy.ProgramColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.Program.class), managedObject, unmanagedObject, cache, flags);
    }
    ...
    public boolean equals(Object o) {
        ...
        com_ninespartans_xmanager_model_ProgramRealmProxy aProgram = (com_ninespartans_xmanager_model_ProgramRealmProxy)o;
