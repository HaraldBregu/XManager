...
public class com_ninespartans_xmanager_model_UserRealmProxy extends com.ninespartans.xmanager.model.User
    implements RealmObjectProxy, com_ninespartans_xmanager_model_UserRealmProxyInterface {
    ...
    private ProxyState<com.ninespartans.xmanager.model.User> proxyState;

    com_ninespartans_xmanager_model_UserRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.ninespartans.xmanager.model.User>(this);
    ...
    @Override
    public com.ninespartans.xmanager.model.Account realmGet$account() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.accountColKey)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.ninespartans.xmanager.model.Account.class, proxyState.getRow$realm().getLink(columnInfo.accountColKey), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$account(com.ninespartans.xmanager.model.Account value) {
    ...
    @SuppressWarnings("cast")
    public static com.ninespartans.xmanager.model.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.ninespartans.xmanager.model.User obj = null;
        if (update) {
            Table table = realm.getTable(com.ninespartans.xmanager.model.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.User.class);
            ...
            if (objKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.User.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_ninespartans_xmanager_model_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("_id")) {
                if (json.isNull("_id")) {
                    obj = (io.realm.com_ninespartans_xmanager_model_UserRealmProxy) realm.createObjectInternal(com.ninespartans.xmanager.model.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_ninespartans_xmanager_model_UserRealmProxy) realm.createObjectInternal(com.ninespartans.xmanager.model.User.class, json.get("_id"), true, excludeFields);
                }
            } else {
        ...
        final com_ninespartans_xmanager_model_UserRealmProxyInterface objProxy = (com_ninespartans_xmanager_model_UserRealmProxyInterface) obj;
        if (json.has("account")) {
            if (json.isNull("account")) {
                objProxy.realmSet$account(null);
            } else {
                com.ninespartans.xmanager.model.Account accountObj = com_ninespartans_xmanager_model_AccountRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("account"), update);
    ...
    public static com.ninespartans.xmanager.model.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.ninespartans.xmanager.model.User obj = new com.ninespartans.xmanager.model.User();
        final com_ninespartans_xmanager_model_UserRealmProxyInterface objProxy = (com_ninespartans_xmanager_model_UserRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.ninespartans.xmanager.model.Account accountObj = com_ninespartans_xmanager_model_AccountRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$account(accountObj);
                }
    ...
    static com_ninespartans_xmanager_model_UserRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.User.class), false, Collections.<String>emptyList());
        io.realm.com_ninespartans_xmanager_model_UserRealmProxy obj = new io.realm.com_ninespartans_xmanager_model_UserRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ninespartans.xmanager.model.User copyOrUpdate(Realm realm, UserColumnInfo columnInfo, com.ninespartans.xmanager.model.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ninespartans.xmanager.model.User) cachedRealmObject;
        }

        com.ninespartans.xmanager.model.User realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.ninespartans.xmanager.model.User.class);
            long pkColumnKey = columnInfo._idColKey;
            long objKey = table.findFirstObjectId(pkColumnKey, ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$_id());
            if (objKey == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(objKey), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_ninespartans_xmanager_model_UserRealmProxy();
    ...
    public static com.ninespartans.xmanager.model.User copy(Realm realm, UserColumnInfo columnInfo, com.ninespartans.xmanager.model.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ninespartans.xmanager.model.User) cachedRealmObject;
        }

        com_ninespartans_xmanager_model_UserRealmProxyInterface unmanagedSource = (com_ninespartans_xmanager_model_UserRealmProxyInterface) newObject;
        ...
        io.realm.com_ninespartans_xmanager_model_UserRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        com.ninespartans.xmanager.model.Account accountObj = unmanagedSource.realmGet$account();
        if (accountObj == null) {
            managedCopy.realmSet$account(null);
        } else {
            com.ninespartans.xmanager.model.Account cacheaccount = (com.ninespartans.xmanager.model.Account) cache.get(accountObj);
            if (cacheaccount != null) {
                managedCopy.realmSet$account(cacheaccount);
            } else {
                managedCopy.realmSet$account(com_ninespartans_xmanager_model_AccountRealmProxy.copyOrUpdate(realm, (com_ninespartans_xmanager_model_AccountRealmProxy.AccountColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.Account.class), accountObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, com.ninespartans.xmanager.model.User object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnKey = columnInfo._idColKey;
        long objKey = Table.NO_MATCH;
        Object primaryKeyValue = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$_id();
        ...
        com.ninespartans.xmanager.model.Account accountObj = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$account();
        if (accountObj != null) {
            Long cacheaccount = cache.get(accountObj);
            if (cacheaccount == null) {
                cacheaccount = com_ninespartans_xmanager_model_AccountRealmProxy.insert(realm, accountObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.accountColKey, objKey, cacheaccount, false);
        }
        String realmGet$fullname = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$fullname();
        if (realmGet$fullname != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fullnameColKey, objKey, realmGet$fullname, false);
        }
        String realmGet$headline = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$headline();
        if (realmGet$headline != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.headlineColKey, objKey, realmGet$headline, false);
        }
        String realmGet$role = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$role();
        if (realmGet$role != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.roleColKey, objKey, realmGet$role, false);
        }
        String realmGet$age = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$age();
        if (realmGet$age != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.ageColKey, objKey, realmGet$age, false);
        }
        String realmGet$emailAddress = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$emailAddress();
        ...
        String realmGet$phoneNumber = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$phoneNumber();
        if (realmGet$phoneNumber != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.phoneNumberColKey, objKey, realmGet$phoneNumber, false);
        }
        java.util.Date realmGet$createdAt = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetTimestamp(tableNativePtr, columnInfo.createdAtColKey, objKey, realmGet$createdAt.getTime(), false);
        }
        java.util.Date realmGet$updatedAt = ((com_ninespartans_xmanager_model_UserRealmProxyInterface) object).realmGet$updatedAt();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.User.class);
        long pkColumnKey = columnInfo._idColKey;
        com.ninespartans.xmanager.model.User object = null;
        while (objects.hasNext()) {
            object = (com.ninespartans.xmanager.model.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ninespartans.xmanager.model.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.ninespartans.xmanager.model.User.class);
        ...
        if (accountObj != null) {
            Long cacheaccount = cache.get(accountObj);
            if (cacheaccount == null) {
                cacheaccount = com_ninespartans_xmanager_model_AccountRealmProxy.insertOrUpdate(realm, accountObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.accountColKey, objKey, cacheaccount, false);
        } else {
    ...
    public static com.ninespartans.xmanager.model.User createDetachedCopy(com.ninespartans.xmanager.model.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ninespartans.xmanager.model.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ninespartans.xmanager.model.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ninespartans.xmanager.model.User) cachedObject.object;
            }
            unmanagedObject = (com.ninespartans.xmanager.model.User) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ninespartans_xmanager_model_UserRealmProxyInterface unmanagedCopy = (com_ninespartans_xmanager_model_UserRealmProxyInterface) unmanagedObject;
        com_ninespartans_xmanager_model_UserRealmProxyInterface realmSource = (com_ninespartans_xmanager_model_UserRealmProxyInterface) realmObject;
        Realm objectRealm = (Realm) ((RealmObjectProxy) realmObject).realmGet$proxyState().getRealm$realm();
        unmanagedCopy.realmSet$_id(realmSource.realmGet$_id());

        // Deep copy of account
        unmanagedCopy.realmSet$account(com_ninespartans_xmanager_model_AccountRealmProxy.createDetachedCopy(realmSource.realmGet$account(), currentDepth + 1, maxDepth, cache));
    ...
    static com.ninespartans.xmanager.model.User update(Realm realm, UserColumnInfo columnInfo, com.ninespartans.xmanager.model.User realmObject, com.ninespartans.xmanager.model.User newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_ninespartans_xmanager_model_UserRealmProxyInterface realmObjectTarget = (com_ninespartans_xmanager_model_UserRealmProxyInterface) realmObject;
        com_ninespartans_xmanager_model_UserRealmProxyInterface realmObjectSource = (com_ninespartans_xmanager_model_UserRealmProxyInterface) newObject;
        Table table = realm.getTable(com.ninespartans.xmanager.model.User.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        builder.addObjectId(columnInfo._idColKey, realmObjectSource.realmGet$_id());

        com.ninespartans.xmanager.model.Account accountObj = realmObjectSource.realmGet$account();
        if (accountObj == null) {
            ...
            if (cacheaccount != null) {
                ...
                builder.addObject(columnInfo.accountColKey, com_ninespartans_xmanager_model_AccountRealmProxy.copyOrUpdate(realm, (com_ninespartans_xmanager_model_AccountRealmProxy.AccountColumnInfo) realm.getSchema().getColumnInfo(com.ninespartans.xmanager.model.Account.class), accountObj, true, cache, flags));
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        com_ninespartans_xmanager_model_UserRealmProxy aUser = (com_ninespartans_xmanager_model_UserRealmProxy)o;
