...
public final class ActivityAccountBinding implements ViewBinding {
  ...
  private ActivityAccountBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ContentAccountBinding content, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ContentAccountBinding binding_content = ContentAccountBinding.bind(content);
      ...
      return new ActivityAccountBinding((CoordinatorLayout) rootView, binding_content, toolbar);
    }
