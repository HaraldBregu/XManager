...
public final class ContentCreateUserBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final AutoCompleteTextView dropdownRoleText;
  ...
  @NonNull
  public final TextInputLayout roleInputText;

  private ContentCreateUserBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull AutoCompleteTextView dropdownRoleText, @NonNull TextView headerDescription,
      @NonNull TextView headerTitle, @NonNull LinearLayout inputFields,
      @NonNull TextInputLayout nameInputText, @NonNull MaterialButton nextButton,
      @NonNull TextInputLayout roleInputText) {
    ...
    this.dropdownRoleText = dropdownRoleText;
    this.headerDescription = headerDescription;
    this.headerTitle = headerTitle;
    this.inputFields = inputFields;
    this.nameInputText = nameInputText;
    this.nextButton = nextButton;
    this.roleInputText = roleInputText;
  }
  ...
  @NonNull
  public static ContentCreateUserBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ContentCreateUserBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.content_create_user, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ContentCreateUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.dropdownRoleText;
      AutoCompleteTextView dropdownRoleText = ViewBindings.findChildViewById(rootView, id);
      if (dropdownRoleText == null) {
        break missingId;
      }
      ...
      id = R.id.roleInputText;
      TextInputLayout roleInputText = ViewBindings.findChildViewById(rootView, id);
      if (roleInputText == null) {
        break missingId;
      }

      return new ContentCreateUserBinding((RelativeLayout) rootView, ageInputText, bottomSection,
          containerSection, dropdownAgeText, dropdownRoleText, headerDescription, headerTitle,
          inputFields, nameInputText, nextButton, roleInputText);
    }
