...
public final class ActivityEditAccountBinding implements ViewBinding {
  ...
  @NonNull
  public final ContentEditAccountBinding content;

  @NonNull
  public final MaterialToolbar toolbar;

  private ActivityEditAccountBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ContentEditAccountBinding content, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityEditAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ContentEditAccountBinding binding_content = ContentEditAccountBinding.bind(content);
      ...
      return new ActivityEditAccountBinding((CoordinatorLayout) rootView, binding_content, toolbar);
    }
