...
public final class ActivityDeviceBinding implements ViewBinding {
  ...
  @NonNull
  public final ContentDeviceBinding content;

  @NonNull
  public final MaterialToolbar toolbar;

  private ActivityDeviceBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ContentDeviceBinding content, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityDeviceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ContentDeviceBinding binding_content = ContentDeviceBinding.bind(content);
      ...
      return new ActivityDeviceBinding((CoordinatorLayout) rootView, binding_content, toolbar);
    }
