...
public final class RowAppDeviceHeaderBinding implements ViewBinding {
  @NonNull
  ...
  private RowAppDeviceHeaderBinding(@NonNull MaterialCardView rootView,
  ...
  @NonNull
  public static RowAppDeviceHeaderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowAppDeviceHeaderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_app_device_header, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowAppDeviceHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowAppDeviceHeaderBinding((MaterialCardView) rootView, appDescription, appName,
