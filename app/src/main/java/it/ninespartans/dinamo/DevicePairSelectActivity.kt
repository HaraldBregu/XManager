...
class DevicePairSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setProgram.setOnClickListener {
            ...
            commandByteArray = commandByteArray.plus(byteArrayOf(0u.toByte(), 2u.toByte(), 0x00))
            commandByteArray = commandByteArray.plus(byteArrayOf(1u.toByte(), 2u.toByte(), 0x00))
            commandByteArray = commandByteArray.plus(byteArrayOf(2u.toByte(), 2u.toByte(), 0x00))
            commandByteArray = commandByteArray.plus(byteArrayOf(3u.toByte(), 2u.toByte(), 0x00))
            commandByteArray = commandByteArray.plus(byteArrayOf(4u.toByte(), 2u.toByte(), 0x00))
